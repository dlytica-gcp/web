...
const TabContent = (props) => {
  ...
  useEffect(() => {
    ...
    if (!hasFetched.current) {
      const dashboardElement = "legal-credit-card-dashboard";
      ...
      <div className="tab">
        ...
        <div className="tab-content">
                  ...
                  <div className="row">
                    <div className="col-md-12 mb-4">
                      <div className="card basic-card">
                        ...
                        <p><span>Blocked Date:</span><span className="value">{convertDateToYMD(item["dim_cards_credit_card.blocked_date"]) || "-"}</span></p>
          ...
          <div className="tab-pane" id="primary-tab-5" role="tabpanel">
            <div className="row">
              <div
                id="legal-credit-card-dashboard"

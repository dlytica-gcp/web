...
const TabContent = (props) => {
  ...
  const fetchAllData = async () => {
    try {
      ...
      const [basicInfo] = await Promise.all([
        legalMobileFetchData.getindivid_mobile_basic_derived_info(legal_id),
      ]);
  ...
  const dashboardElement = "legal-mobile-banking-dashboard";
  useEffect(() => {
    fetchAllData();
      ...
      <div className="tab">
        ...
        <div className="tab-content">
          ...
          <div className="tab-pane" id="primary-tab-5" role="tabpanel">
            ...
            <div className="row">
              <div
                id="legal-mobile-banking-dashboard"

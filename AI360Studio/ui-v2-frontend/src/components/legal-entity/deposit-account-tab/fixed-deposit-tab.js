...
const TabContent = (props) => {
  ...
  const fetchAllData = async () => {
    try {
      ...
      const [basicInfo, lienData, interestrate, nominee, signatories] =
        await Promise.all([
          legalDepositFetchData.getsavingdepo_basicinfo_derived(foracid, cif_id, "Fixed"),
          legalDepositFetchData.getsaving_deposit_lien_details(foracid, cif_id),
          legalDepositFetchData.getsaving_deposit_interest_rate_details(foracid, cif_id),
          legalDepositFetchData.getsaving_deposit_nominee_details(foracid, cif_id),
          legalDepositFetchData.getsaving_deposit_signatories_details(foracid, cif_id),
        ]);
  ...
  const dashboardElement = "legal-fixed-dashboard";
  useEffect(() => {
    if (foracid && cif_id) {
      fetchAllData();
    }
    const filters = {
      cif_id: cif_id,
      foracid: foracid,
      product_scheme_sub_category: "Fixed",
    };
  ...
  }, [foracid, cif_id, individualData, lienData, signatoriesData, interestRateData, nomineeData]);
                        ...
                        <div className="col-md-12 mb-4">
                          <div className="card basic-card">
                            ...
                            <p>
                              ...
                              <span className="value">
                                {data[
                                  "fact_transaction_details.first_account_since"
                                ] || "-"}
                              </span>
                            </p>
                            <p>
                              ...
                              <span className="value">
                                {data[
                                  "fact_transaction_details.dormant_since"
                                ] || "-"}
                              </span>
                            </p>
                            <p>
                              ...
                              <span className="value">
                                {data[
                                  "fact_transaction_details.freeze_since"
                                ] || "-"}
                              </span>
                            </p>
                            <p>
                              ...
                              <span className="value">
                                {data[
                                  "fact_transaction_details.last_customer_induced_transaction"
                                ] || "-"}
                              </span>
                            </p>
                            <p>
                              ...
                              <span className="value">
                                {data[
                                  "fact_transaction_details.last_digital_txn_since"
                                ] || "-"}
                              </span>
                            </p>
                            <p>
                              ...
                              <span className="value">
                                {data[
                                  "fact_transaction_details.last_branch_txn_since"
                                ] || "-"}
                              </span>
                            </p>
                            <p>
                              ...
                              <span className="value">
                                {data[
                                  "fact_transaction_details.days_since_first_customer_induced_txn"
                                ] || "-"}
                              </span>
                            </p>
                          </div>

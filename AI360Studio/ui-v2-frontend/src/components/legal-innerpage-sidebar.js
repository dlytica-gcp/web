...
const LegalPageSidebar = (props) => {
  const { legal_id } = props;
 
  useEffect(() => {
    const sidebarLinks = document.querySelectorAll('.sidebar-link, .sidebar-dot-link');
  ...
  return (
      ...
      <div className="sidebar-content js-simplebar" data-simplebar="init">
        <div className="simplebar-wrapper" style={{ margin: '0px' }}>
          ...
          <li className="sidebar-item">
            <a data-bs-target="#dashboards" data-bs-toggle="collapse" className="sidebar-link collapsed">
              <i className="align-middle" data-feather="sliders"></i> <span className="align-middle">Executive Dashboards</span>
            </a>
          ...
          <li className="sidebar-item active">
            ...
            <li className="sidebar-item"><a className='sidebar-link' href='/individ'>Individual</a></li>
              <li className="sidebar-item">
                <a data-bs-target="#legal-individual-submenu" data-bs-toggle="collapse" className="sidebar-link collapsed">Legal Entity</a>
                <ul id="legal-individual-submenu" className="sidebar-dropdown list-unstyled collapse show">
                  <li className="sidebar-item active">
                  ...
                  <li className="sidebar-item">
                    <Link href={`/legal-entities/deposit?legal_id=${legal_id}`} legacyBehavior>
                      <a className="sidebar-dot-link">Deposit</a>
                    </Link>
                  </li>
                  <li className="sidebar-item">
                    <Link href={`/legal-entities/loan?legal_id=${legal_id}`} legacyBehavior>
                      <a className="sidebar-dot-link">Loan</a>
                    </Link>
                  </li>
                  <li className="sidebar-item">
                    <Link href={`/legal-entities/cards?legal_id=${legal_id}`} legacyBehavior>
                  ...
                  <li className="sidebar-item">
                    ...
                    <ul id="digital-submenu" className="sidebar-dropdown list-unstyled collapse">
                      <li className="sidebar-item">
                        <Link href={`/legal-entities/digital/mobile-banking?legal_id=${legal_id}`} legacyBehavior>
                  ...
                  <li className="sidebar-item">
                    ...
                    <ul id="other-submenu" className="sidebar-dropdown list-unstyled collapse">
                      ...
                      <li className="sidebar-item">
                        <Link href={`/legal-entities/qr/qr?legal_id=${legal_id}`} legacyBehavior>
                          <a className="sidebar-dot-link">QR</a>
                        </Link>
                      </li>
                      <li className="sidebar-item">
                        <Link href={`/legal-entities/pos/pos?legal_id=${legal_id}`} legacyBehavior>
              ...
              {/* <li className="sidebar-item">
                <Link href="/legalentity-individual" legacyBehavior>
        ...
        <div className="simplebar-placeholder" style={{ width: '232px', height: '1022px' }}></div>
      </div>
      <div className="simplebar-track simplebar-horizontal" style={{ visibility: 'hidden' }}>
        <div className="simplebar-scrollbar simplebar-visible" style={{ transform: 'translate3d(0px, 0px, 0px)', display: 'none' }}></div>
      </div>
      <div className="simplebar-track simplebar-vertical" style={{ visibility: 'visible' }}>
        <div className="simplebar-scrollbar simplebar-visible" style={{ height: '129px', transform: 'translate3d(0px, 0px, 0px)', display: 'block' }}></div>
      </div>
      </>

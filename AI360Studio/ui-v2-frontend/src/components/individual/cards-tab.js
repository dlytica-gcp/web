...
const TabContent = (props) => {
  ...
  const fetchAllData = useCallback(async () => {
    try {
      ...
      const [
        ...
        cardFetchData.getindivid_card_basic_info(inv_id),
        cardFetchData.getindivid_credit_card_breakdown_info(inv_id),
        cardFetchData.getindivid_debit_card_breakdown_info(inv_id),
        cardFetchData.getindivid_debit_card_details_info(inv_id),
        cardFetchData.getindivid_credit_card_details_info(inv_id),
      ]);

      // Set all data states
      setIndividBasicInfo(basicinfo);
      console.log("cardbasic info",basicinfo);
                        ...
                        <div className="card">
                          <div className="card-body">
                            ...
                            <h1 className="mt-1 mb-3">
                              {data["dim_cards_card.total_active_cards"] ? data["dim_cards_card.total_active_cards"] :
                                "N/A"}
                            </h1>
                          </div>
                        </div>
                      ...
                      <div className="col-sm-6">
                        <div className="card">
                          <div className="card-body">
                            ...
                            <h1 className="mt-1 mb-3">
                              {data["dim_cards_card.total_transactions"] ? data["dim_cards_card.total_transactions"] :
                                "N/A"}
                            </h1>
                          </div>
                        </div>
                        ...
                        <div className="card">
                          <div className="card-body">
                            ...
                            <h1 className="mt-1 mb-3">
                              {data["dim_cards_card.total_cards"] ? data["dim_cards_card.total_cards"] : "N/A"}
                            </h1>
                          </div>
                        </div>
                      </div>
  ...
  <a href="/individuals/cards-account/debit-card">
    11
                            ...
                            <td>
                              <Link
                                href={`/individuals/cards-account/debit-card?cif_id=${inv_id}&card_id=${encodeURIComponent(
                    ...
                    <table className="table">
                      ...
                      <tbody>
                        {individCreditCardDetail && individCreditCardDetail.map((item, index) => (
                          <tr key={index}>
                            <td>
                              <Link href={`/individuals/cards-account/credit-card?cif_id=${inv_id}&card_id=${encodeURIComponent(encryptCardNumber(item["dim_cards_credit_card.car_numb"]))}`}>

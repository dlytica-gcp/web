...
const TabContent = (props) => {
  ...
  const fetchAllData = useCallback(async () => {
    try {
      ...
      const [basicInfo] = await Promise.all([
        loanFetchData.getfunded_loan_basic_derived_info(foracid),
      ]);
  ...
  const dashboardElement = "funded-loan-account-dashboard";
  useEffect(() => {
    fetchAllData();
      ...
      <div className="tab">
        ...
        <div className="tab-content">
          ...
          <div className="tab-pane" id="primary-tab-4" role="tabpanel">
            <div
              id="funded-loan-account-dashboard"

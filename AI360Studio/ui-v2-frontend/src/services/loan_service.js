...
const loanFetchData = {
  ...
  getindivid_loan_basic_derived_info: async (id) => {
    const response = await axios.post(
      process.env.NEXT_PUBLIC_CUBE_API_URL,

      {
        query: {
          dimensions: [
            "dim_loan_accounts_funded.total_number_of_funded_loans",
            "dim_loan_accounts_funded.total_sanction_limit",
            "dim_loan_accounts_funded.total_outdrawing_power",
            "dim_loan_accounts_funded.total_overdue_amount",
            "dim_loan_accounts_funded.first_overdue_date",
          ],
          order: { "dim_loan_accounts_funded.ra_unit": "asc" },
          filters: [
            {
...

      {
        query: {
          ...
          dimensions: [
            ...
            "dim_loan_accounts_funded.group_id",
            "dim_loan_accounts_funded.group_code",
            "dim_loan_accounts_funded.customer_group",
            "dim_loan_accounts_funded.overdue_amount",
            "dim_loan_accounts_funded.full_rate",
            "dim_loan_accounts_funded.base_rate",
            "dim_loan_accounts_funded.preference_rate",
            "dim_loan_accounts_funded.currency",
            "dim_loan_accounts_funded.riskgrade",
            "dim_loan_accounts_funded.internal_riskgrade",
            "dim_loan_accounts_funded.base_l2",
            "dim_loan_accounts_funded.emi_flag",
            "dim_loan_accounts_funded.operative_account",
            "dim_loan_accounts_funded.next_interest_demand_date",
            "dim_loan_accounts_funded.next_principal_demand_date",
            "dim_loan_accounts_funded.first_overdue_loan_date",
            "dim_loan_accounts_funded.days_between_account_opening_and_loan_sanction",
            "dim_loan_accounts_funded.limit_expiry_days_in",
            "dim_loan_accounts_funded.limit_review_days_in",

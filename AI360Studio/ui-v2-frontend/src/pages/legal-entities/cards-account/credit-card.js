...
import TabContent from "@/components/legal-entity/cards-account-tab/credit-card-tab";
...
export default function FundedLoan() {
  ...
  const breadcrumbLinks = [
    ...
    {
      href: `/legal-entities/cards-account/credit-card?legal_id=${legal_id}&foracid=${foracid}&cif_id=${cif_id}`,
      label: "Credit Card",
    },
  ];
  return (
            ...
            <div className="container-fluid p-0">
              <div className="row mb-2 mb-xl-3">
                <div className="col-auto d-none d-sm-block">
                  <h3>
                    <strong>Legal Entity Credit </strong>Card
                  </h3>
                </div>

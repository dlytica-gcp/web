...
import TabContent from "@/components/legal-entity/digital/mobile-banking-tab";
...
export default function Loan() {
  ...
  const breadcrumbLinks = [
    ...
    {
      href: `/legal-entities/digital/mobile-banking/${legal_id}`,
          ...
          <main className="content">
            <div className="container-fluid p-0">
              ...
              <div className="row">
                ...
                <TabContent legal_id={legal_id} mobilebanking={mobilebanking} />
              </div>
            </div>
          </main>
          <Footer />

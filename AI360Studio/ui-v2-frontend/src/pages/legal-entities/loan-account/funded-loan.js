...
import TabContent from "@/components/legal-entity/loan-account-tab/funded-loan-tab";
...
export default function FixedDeposit() {
  ...
  const breadcrumbLinks = [
    ...
    { href: `/legal-entities/loan/${legal_id}`, label: "Loan" },
    {
      href: `/legal-entities/loan-account/funded-loan?legal_id=${legal_id}&foracid=${foracid}&cif_id=${cif_id}`,
      label: "Funded Loan",
    },
  ];
  return (
            ...
            <div className="container-fluid p-0">
              <div className="row mb-2 mb-xl-3">
                <div className="col-auto d-none d-sm-block">
                  <h3>
                    <strong>Legal Entity Funded Loan </strong>Account
                  </h3>
                </div>

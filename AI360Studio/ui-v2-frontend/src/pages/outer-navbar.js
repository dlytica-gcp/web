...
<div className="navbar-collapse collapse">
  <ul className="navbar-nav navbar-align">
    {/* <li className="nav-item dropdown">
      <a className="nav-icon dropdown-toggle" href="index.html#" id="alertsDropdown" data-bs-toggle="dropdown">
      ...
      <div className="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="alertsDropdown">
        ...
        <div className="dropdown-menu-footer">
          <a href="index.html#" className="text-muted">Show all notifications</a>
        </div>
      </div>
    </li> */}
    ...
    */}
    ...
    <li className="nav-item dropdown">
      <a className="nav-icon pe-md-0 dropdown-toggle" href="index.html#" data-bs-toggle="dropdown">

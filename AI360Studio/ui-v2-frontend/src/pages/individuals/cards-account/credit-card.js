...
import TabContent from "@/components/individual/cards-account-tab/credit-card-tab";
...
export default function FundedLoan() {
  ...
  const breadcrumbLinks = [
    ...
    {
      href: `/individuals/cards-account/credit-card?inv_id=${inv_id}&foracid=${foracid}&cif_id=${cif_id}`,
      label: "Credit Card",
    },
  ];
  return (

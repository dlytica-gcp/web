...
import TabContent from "@/components/individual/deposit-account-tab/saving-deposit-tab";
...
export default function SavingDeposit() {
  ...
  const breadcrumbLinks = [
    ...
    { href: `/individuals/deposit?inv_id=${cif_id}`, label: "Deposit" },
    {
      href: `/individuals/deposit-account/saving-deposit?inv_id=${inv_id}&foracid=${foracid}&cif_id=${cif_id}`,
            ...
            <div className="container-fluid p-0">
              <div className="row mb-2 mb-xl-3">
                <div className="col-auto d-none d-sm-block">
                  <h3>
                    <strong>Saving Deposit </strong>Account
                  </h3>
                </div>

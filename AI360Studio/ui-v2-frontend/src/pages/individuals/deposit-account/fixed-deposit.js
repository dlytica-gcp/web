...
import TabContent from "@/components/individual/deposit-account-tab/fixed-deposit-tab";
...
export default function FixedDeposit() {
  ...
  const breadcrumbLinks = [
    ...
    {
      href: `/individuals/deposit-account/fixed-deposit?inv_id=${inv_id}&foracid=${foracid}&cif_id=${cif_id}`,
      label: "Fixed Deposit",
    },
  ];
  return (
            ...
            <div className="container-fluid p-0">
              <div className="row mb-2 mb-xl-3">
                <div className="col-auto d-none d-sm-block">
                  <h3>
                    <strong>Fixed Deposit </strong>Account
                  </h3>
                </div>
